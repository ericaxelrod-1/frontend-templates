...
async function runAllMigrations() {
  ...
  console.log('This will ensure permissions table has the correct structure and relationships.');
  ...
  try {
    ...
    if (permissionsTableExists) {
      ...
      console.log(`Permissions with empty resource_name: ${emptyResourceNameCount[0].count}`);
      console.log(`Permissions with empty action: ${emptyActionCount[0].count}`);
    }
