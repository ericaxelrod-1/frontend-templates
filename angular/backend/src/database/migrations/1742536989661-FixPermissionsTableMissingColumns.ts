...
export class FixPermissionsTableMissingColumns1742536989661
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    console.log(
      'Starting migration to fix permissions table missing columns...',
    );
    ...
    console.log(
      `Current columns in permissions table: ${columnNames.join(', ')}`,
    );
    ...
    console.log(
      `Updated columns in permissions table: ${updatedColumnNames.join(', ')}`,
    );
