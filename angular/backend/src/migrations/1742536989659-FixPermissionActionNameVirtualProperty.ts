...
export class FixPermissionActionNameVirtualProperty1742536989659 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (!actionColumnExists) {
            ...
            const actionNameColumnExists = await queryRunner.hasColumn(tableName, 'action_name');
        ...
        // Log success
        console.log(`Successfully updated ${tableName} table to support actionName virtual property`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        console.log('No database changes to revert for actionName virtual property');
    }
} 