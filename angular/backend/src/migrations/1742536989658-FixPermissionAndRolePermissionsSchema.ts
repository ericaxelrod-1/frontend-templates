    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (!permissionsTableExists) {
            ...
            if (permissionTableExists) {
                ...
                const columns = await queryRunner.query("PRAGMA table_info(permission)");
                ...
                const tempTableExists = await queryRunner.hasTable('role_permissions_temp');
                if (tempTableExists) {
                    console.log('Dropping existing role_permissions_temp table from previous migration attempt');
