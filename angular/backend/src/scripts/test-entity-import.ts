...
try {
  ...
  if (PermissionModule && PermissionModule.Permission) {
    console.log("Successfully imported Permission entity class:", PermissionModule.Permission.name);
  } else {
    console.error("Failed to import Permission entity correctly or Permission class missing.");
  }
} catch (e) {
...
try {
  ...
  if (ActionModule && ActionModule.Action) {
    console.log("Successfully imported Action entity class:", ActionModule.Action.name);
  } else {
    console.error("Failed to import Action entity correctly or Action class missing.");
  }
} catch (e) {
...
try {
    ...
    if (typeorm && typeorm.Entity) {
        ...
        console.error("Failed to import 'typeorm' correctly or Entity decorator missing.");
    }
} catch (e) {
